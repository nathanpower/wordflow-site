  ...
  render () {
    return (
      <div className="contact-form-container row center-xs middle-xs around-xs col-xs-12">
        <div className="contact-form col-xs-7 row center-xs">
          ...
          <form className="row col-xs-12 center-xs between-xs">
            <input placeholder="Your name *" type="text" className="col-xs-4" />
            <input placeholder="Your email *" type="text" className="col-xs-7" />
